...
module Bulkrax
  RSpec.describe MetsXmlEntry, type: :model do
    ...
    xdescribe '#build' do
      ...
      xcontext 'without raw_metadata' do
        before do
    ...
    describe '#add_logical_structure' do
      # call the method
      # expect be a ruby hash
